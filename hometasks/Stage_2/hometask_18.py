...
# Задача 4
# Напишіть програму,
# яка буде запитувати у користувача його імʼя та додавати його до списку list_a, який знаходиться в цьому ж файлі.
# Функцію ми нічого не передаємо.
